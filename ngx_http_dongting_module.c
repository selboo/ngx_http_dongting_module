...
static ngx_command_t  ngx_http_log_commands[] = {
    ...
    { ngx_string("dongting_log_file_cache"),
...
static ngx_http_module_t  ngx_http_dongting_module_ctx = {
...
ngx_module_t  ngx_http_dongting_module = {
    NGX_MODULE_V1,
    &ngx_http_dongting_module_ctx,              /* module context */
    ...
    u_char **name, u_char *buf, size_t len)
{
    ...
    *name = log.data;
    ...
    llcf = ngx_http_get_module_loc_conf(r, ngx_http_dongting_module);
...
ngx_http_log_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    lmcf = ngx_http_conf_get_module_main_conf(cf, ngx_http_dongting_module);
